...
class LanguageList:
    ...
    lang_array['000-85056'] = 'If owner privileges are not checked, you must enter a connection string.'
    ...
    lang_array['000-86001'] = 'Resource Plan List / Resource Plan Management / Exastro Platform'
