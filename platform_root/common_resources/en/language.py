...
class LanguageList:
    ...
    lang_array['400-00037'] = 'The value is outside the range of specifiable values. (item: {0}, Minimum number: {1}, Maximum number: {2})'
    lang_array['400-00038'] = 'There is a difference in the URL origin for "ServiceNow API URL (Individual registration)" and "ServiceNow API URL (Bulk registration)".'
