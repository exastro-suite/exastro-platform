...
$(function(){
    ...
    function load_main() {
        Promise.all([
            ...
            displayTopicPath([
                {
                    "text": getText("000-81004", "トークン発行"),
                    "href": CommonAuth.isPlatformAdminSite()?
                                location_conf.href.account.platform_admin_site.token:
                                location_conf.href.account.organization_user_site.token.replace(/{organization_id}/g, CommonAuth.getRealm())
                },
            ]);
            // Display Token List
