...
$(function(){
    ...
    function load_main() {
        Promise.all([
            ...
            // Display Menu
            displayMenu('menu_agent_user_list');
            // Display Topic Path
            displayTopicPath([
                {"text": getText("000-83001", "エージェントユーザー一覧"), "href": location_conf.href.agentusers.list.replace(/{organization_id}/g, CommonAuth.getRealm()) }
            ]);
