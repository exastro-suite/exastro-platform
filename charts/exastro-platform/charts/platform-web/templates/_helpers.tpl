...
Common labels
*/}}
{{- define "platform-web.labels" -}}
helm.sh/chart: {{ include "platform-web.chart" . }}
{{ include "platform-web.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "platform-web.selectorLabels" -}}
app.kubernetes.io/name: {{ include "platform-web.name" . }}
...
Image name
*/}}
{{- define "platform-web.repository" -}}
...
*/}}
{{- define "platform-web.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "platform-web.fullname" .) .Values.serviceAccount.name }}
{{- else }}
